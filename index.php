	...
	<form method="post" action="">
		<div class="row">
			<div class="col-xs-12">
				...
				if(!empty($errors)) {
					...
					<div class="alert alert-danger">
						...
						if(in_array('ENTRY_CODE_INVALID', $errors)) {
							?>
							<strong>Kod jest nieprawidłowy</strong><br>
							Podaj poprawny kod						<?php
						}
						?>
					</div>
				<?php
				...
				<button type="submit" name="form_submit" value="submitted" class="btn btn-primary btn-full">Wyślij<i class="fa fa-angle-right"></i></button>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</form>
</section>
